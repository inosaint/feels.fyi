...
#ifndef FEELS_FYI_SWIFT_H
#define FEELS_FYI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="feels_fyi",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class CLLocation;
SWIFT_CLASS("_TtC9feels_fyi15LocationManager")
